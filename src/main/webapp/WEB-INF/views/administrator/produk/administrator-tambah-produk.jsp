...
<title>Tambah Produk | Hardware IT Solution</title>
...
<body>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="page-title">                    
				<h2><span class="fa fa-arrow-circle-o-left"></span> Tambah Produk</h2>
			</div> <!-- .page-title -->
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<form:select path="kategori" cssClass="form-control select" data-live-search="true">
											<form:options items="${kategoriList }" itemValue="nama" itemLabel="nama" />
										</form:select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<form:select path="brand" cssClass="form-control select" data-live-search="true">
											<form:options items="${brandList }" itemValue="nama" itemLabel="nama" />
										</form:select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<div class="input-group">
											...
											<form:input path="harga" cssClass="validate[required,custom[integer],min[1]] form-control" placeholder="Inputkan harga produk"/>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<form:textarea path="detailProduk" cssClass="form-control" cols="5" placeholder="Inputkan detail produk"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<form:textarea path="deskripsi" cssClass="form-control" cols="5" placeholder="Inputkan deskripsi lengkap produk"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<div class="input-group">
											...
											<form:input path="stok" cssClass="validate[required,custom[integer],min[1]] form-control" placeholder="Inputkan stok produk"/>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12">
										<form:textarea path="spesifikasi" cssClass="form-control" cols="5" placeholder="Inputkan spesifikasi lengkap produk"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-xs-12"> 
										<form:input type="file" path="filename" cssClass="fileinput btn-primary" title="Browse file" accept="image/x-png, image/gif, image/jpeg"/>
									</div>
								</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#sidebar-tambah-produk').addClass('active');
			$('#produk').validationEngine();
		});
	</script>
</body>
</html>