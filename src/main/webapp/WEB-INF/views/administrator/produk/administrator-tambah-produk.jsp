      ...
      <div class="page-content-wrap">
         <div class="row">
            <div class="col-md-12">
               ...
               <form:form modelAttribute="produk"
                          action="${pageContext.request.contextPath }/administrator/produk/tambah_post"
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:select path="kategori" cssClass="form-control select"
                                           data-live-search="true">
                                 <form:options items="${kategoriList }" itemValue="nama"
                                               itemLabel="nama"/>
                              </form:select>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:select path="brand" cssClass="form-control select"
                                           data-live-search="true">
                                 <form:options items="${brandList }" itemValue="nama"
                                               itemLabel="nama"/>
                              </form:select>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:textarea path="detailProduk" cssClass="form-control" cols="5"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:textarea path="deskripsi" cssClass="form-control" cols="5"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:textarea path="spesifikasi" cssClass="form-control" cols="5"
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:input type="file" path="filename"
                                          cssClass="fileinput btn-primary" title="Browse file"
