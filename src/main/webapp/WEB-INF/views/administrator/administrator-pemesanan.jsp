	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="page-title">                    
				<h2><span class="fa fa-arrow-circle-o-left"></span> Pemesanan</h2>
			</div> <!-- .page-title -->
								...
								<table class="table table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td>Rp. <c:out value="${pemesanan.totalHarga }" /> </td>
											<td>
												<c:choose>
											...
											<td>
												<a href='<spring:url value="/administrator/pemesanan/cetak/${pemesanan.id}" />' title="Lihat Detail Pemesanan" class="btn btn-info btn-rounded btn-sm"><span class="fa fa-search"></span></a>
											</td>
										</tr>
										</c:forEach>
