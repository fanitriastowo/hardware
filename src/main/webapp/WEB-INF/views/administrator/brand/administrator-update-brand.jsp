...
<title>Update Brands | Hardware IT Solution</title>
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Update Brands</li>
			</ul>
			<!-- .breadcrumb -->
			...
			<div class="page-title">
				<h2>
					<span class="fa fa-arrow-circle-o-left"></span> Update Brands
				</h2>
			</div>
			<!-- .page-title -->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<form:form
							commandName="brand"
							role="form"
							action="${pageContext.request.contextPath }/administrator/brand/update"
