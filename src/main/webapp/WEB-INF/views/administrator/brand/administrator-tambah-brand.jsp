			...
			<div class="page-content-wrap">
				<div class="row">
					<div class="col-md-12">
						...
						<!-- form -->
						<form:form commandName="brand" role="form" action="${pageContext.request.contextPath }/administrator/brand/tambah_post" cssClass="form-horizontal" method="post">
						<div class="panel panel-default">
							...
							<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">                                            
											<div class="input-group">
												...
												<form:input path="nama" cssClass="validate[required,minlength[3]] form-control" placeholder="Inputkan nama brand"/>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<form:textarea path="deskripsi" cssClass="form-control" rows="5" placeholder="Inputkan deskripsi brand"/>
										</div>
									</div>
