      ...
      <div class="page-content-wrap">
         <div class="row">
            <div class="col-md-12">
               ...
               <form:form commandName="pengiriman"
                          action="${pageContext.request.contextPath }/administrator/pengiriman/tambah_post"
                          method="post"
                     ...
                     <div class="panel-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:select path="pemesananId" cssClass="form-control select"
                                           data-live-search="true">
                                 <form:options items="${pemesananList }" itemValue="pemesananId"
                                               itemLabel="pemesananId"/>
                              </form:select>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:select path="email" cssClass="form-control select"
                                           data-live-search="true">
                                 <form:options items="${userList }" itemValue="username"
                                               itemLabel="username"/>
                              </form:select>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <div class="input-group">
                                 ...
                                 <form:input path="jneId" cssClass="form-control"
                                             placeholder="Inputkan Nomor Resi JNE"/>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:textarea path="alamatPengiriman" cssClass="form-control"
                                             cols="5" placeholder="Inputkan Alamat"/>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:select path="kabupaten" cssClass="form-control select"
                                           data-live-search="true">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <div class="input-group">
                                 ...
                                 <form:input path="tanggalPengiriman"
                                             cssClass="form-control datepicker"
                                             placeholder="Inputkan Tanggal Pengiriman"/>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-xs-12">
                              <form:select path="statusPengiriman" cssClass="form-control select">
                                 <form:option
                                         value="PROSES_PENGIRIMAN">Proses Pengiriman</form:option>
                                 <form:option
                                         value="BATAL_PENGIRIMAN">Pengiriman Dibatalkan</form:option>
                              </form:select>
                           </div>
                        </div>
