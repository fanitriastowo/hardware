                        ...
                        <c:forEach items="${pengirimanList }" var="pengiriman" varStatus="index">
                           <tr>
                              ...
                              <td>
                                 ...
                                 <label class="label label-success"><c:out
                                         value="${pengiriman.statusPengiriman }"/></label>
                                 </c:when>
                                 <c:otherwise>
                              ...
                              <td>
                                 <a href='<spring:url value="/administrator/pengiriman/cetak_detail/${pengiriman.id}" />'
                                    title="Lihat Detail Pengiriman"
                                    class="btn btn-info btn-rounded btn-sm"><span
