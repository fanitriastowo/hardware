...
<title>Update Member | Hardware IT Solution</title>
   ...
   <div class="page-container">
      ...
      <div class="page-content">
         ...
         <div class="page-title">
            <h2>
               <span class="fa fa-arrow-circle-o-left"></span> Update Member
            </h2>
         </div>
         <!-- .page-title -->
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <form:form
                     ...
                     action="${pageContext.request.contextPath }/administrator/member/update"
                     method="post">
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                              ...
                              <div class="col-md-6 col-xs-12">
                                 <div class="input-group">
                                    ...
                                    <form:input
                                       ...
                                       placeholder="Inputkan nama lengkap member" />
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6 col-xs-12">
                                 <div class="input-group">
                                    <span class="input-group-addon"><span class="fa fa-lock"></span></span> <input
                                       type="password"
                                       class="form-control"
                                       id="confirm_password"
                           ...
                           <div class="form-group">
                              <label
                                 class="col-md-3 col-xs-12 control-label"
                                 for="jenisKelamin">Jenis Kelamin</label>
