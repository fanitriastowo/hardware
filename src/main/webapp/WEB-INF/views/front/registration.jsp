         ...
         <div class="row">
            ...
            <div class="registration-panel">
               ...
               <div class="col-sm-offset-1 col-sm-4">
                  <form:form
                     ...
                     <div class="form-group text-muted agree-statement">
                        <p>Dengan menekan Registrasi, saya mengkonfirmasi telah menyetujui Syarat dan Ketentuan, serta Kebijakan Privasi IT
                           Solution.</p>
                     </div>
                     <div class="form-group">
                        <button
               ...
               <div class="col-sm-5">
                  ...
                  <hr>
                  <p>Syarat &amp; ketentuan yang ditetapkan di bawah ini mengatur pemakaian jasa yang ditawarkan oleh CV. IT Solution terkait
                     penggunaan situs www.hardware.itsolution.com. Pengguna disarankan membaca dengan seksama karena dapat berdampak kepada hak dan
                     kewajiban Pengguna di bawah hukum.</p>
                  <p>Dengan mendaftar dan/atau menggunakan situs www.hardware.itsolution.com, maka pengguna dianggap telah membaca, mengerti,
                     memahami dan menyutujui semua isi dalam Syarat &amp; ketentuan. Syarat &amp; ketentuan ini merupakan bentuk kesepakatan yang
                     dituangkan dalam sebuah perjanjian yang sah antara Pengguna dengan CV. IT Solution. Jika pengguna tidak menyetujui salah satu,
                     sebagian, atau seluruh isi Syarat &amp; ketentuan, maka pengguna tidak diperkenankan menggunakan layanan di
