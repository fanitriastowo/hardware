...
<link rel="stylesheet" href='<spring:url value="/assets/front/css/registration.css" />'>
</head>
<body>
	...
	<section id="registration">
		<div class="container">
			<div class="row">
				<h3 class="text-center"><strong>DAFTAR GRATIS DI IT-SOLUTION</strong></h3>
				<p class="text-center">Sudah punya akun? Masuk <a href='<spring:url value="/login" />'>disini</a></p>
				...
				<div class="registration-panel">
						...
						<form:form commandName="user" cssClass="form-horizontal form-registrasi" action="${pageContext.request.contextPath }/registration/register" method="post">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<form:input path="nama" cssClass="form-control" placeholder="Nama Lengkap" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									...
									<form:input path="phone" cssClass="form-control" placeholder="Nomor Telepon" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									...
									<form:input path="username" type="email" cssClass="form-control" placeholder="Email" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="form-inline">
									<form:select path="tanggal" cssClass="form-control">
									...
									<form:select path="bulan" cssClass="form-control">
									...
									<form:select path="tahun" cssClass="form-control">
							...
							<div class="form-group">
								...
								<div class="form-inline">
									<label class="radio-inline"> <form:radiobutton path="jenisKelamin" value="lakilaki" />&nbsp;Laki-laki</label> 
									<label class="radio-inline"> <form:radiobutton path="jenisKelamin" value="perempuan" />&nbsp;Perempuan</label> 
								</div>
							</div>
							<div class="form-group text-muted agree-statement">
								<p>Dengan menekan Registrasi, saya mengkonfirmasi telah menyetujui Syarat dan Ketentuan, serta Kebijakan Privasi IT Solution.</p>
							</div>
							<div class="form-group">
					...
					<div class="col-sm-5">
						<strong>Syarat dan Ketentuan</strong> <hr>
						<p>
							Syarat &amp; ketentuan yang ditetapkan di bawah ini mengatur pemakaian jasa yang ditawarkan oleh CV. IT Solution terkait penggunaan situs
							www.hardware.itsolution.com. Pengguna disarankan membaca dengan seksama karena dapat berdampak kepada hak dan kewajiban Pengguna di bawah
							hukum.
						</p>
						<p>
							Dengan mendaftar dan/atau menggunakan situs www.hardware.itsolution.com, maka pengguna dianggap telah membaca, mengerti, memahami dan menyutujui
							semua isi dalam Syarat &amp; ketentuan. Syarat &amp; ketentuan ini merupakan bentuk kesepakatan yang dituangkan dalam sebuah perjanjian yang
							sah antara Pengguna dengan CV. IT Solution. Jika pengguna tidak menyetujui salah satu, sebagian, atau seluruh isi Syarat &amp; ketentuan, maka
							pengguna tidak diperkenankan menggunakan layanan di www.hardware.itsolution.com.</p>
					</div> <!-- .col-sm-5 -->
	...
	<script type="text/javascript" src='<spring:url value="/assets/front/js/jquery.validate.min.js" />'></script>
