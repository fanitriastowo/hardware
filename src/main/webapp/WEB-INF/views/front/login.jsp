...
<link rel="stylesheet" href='<spring:url value="/assets/front/css/login.css" />'>
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-md-offset-4">
					<a href='<spring:url value="/" />'>
						<img class="img-rounded center-block" src='<spring:url value="/assets/front/images/logo.png" />' alt="Logo" style="background: #34495e;">
					</a>
					<h1 class="text-center login-title">Login to continue Shopping</h1>
					<div class="account-wall">
						<img class="profile-img" src='<spring:url value="/assets/front/images/user-blank.jpg" />' alt="User Avatar">
						...
						<form class="form-signin" action='<spring:url value="/j_spring_security_check"/>' method="post">
							...
							<a href='<spring:url value="/guide" />' class="pull-right need-help">Need help? </a><span class="clearfix"></span>
						</form>
						
					</div>
					<a href='<spring:url value="/registration" />' class="text-center new-account">Create an account </a><br>
