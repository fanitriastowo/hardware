<div class="page-sidebar">
   <ul class="x-navigation">
         ...
         <ul>
            <li id="sidebar-daftar-pengiriman">
               <a href='<spring:url value="/administrator/pengiriman" />'>
                  <span class="fa fa-align-justify"></span> <span
                       class="xn-text">Daftar Pengiriman</span></a>
            </li>
            <li id="sidebar-tambah-pengiriman">
               <a href='<spring:url value="/administrator/pengiriman/tambah" />'>
                  <span class="fa fa-plus-square-o"></span> <span
                       class="xn-text">Input Pengiriman</span></a>
            </li>
         </ul>
      </li>
      ...
      <li id="sidebar-produk" class="xn-openable">
         ...
         <ul>
            <li id="sidebar-daftar-produk"><a
                    href='<spring:url value="/administrator/produk" />'><span
                    class="fa fa-align-justify"></span> Daftar Produk</a></li>
            <li id="sidebar-tambah-produk"><a
                    href='<spring:url value="/administrator/produk/tambah" />'><span
                    class="fa fa-plus-square-o"></span> Tambah Produk</a></li>
         </ul>
      </li>
      <li id="sidebar-kategori" class="xn-openable">
         <a href="#"><span class="fa fa-archive"></span> <span class="xn-text">Kategori</span></a>
         <ul>
            <li id="sidebar-daftar-kategori"><a
                    href='<spring:url value="/administrator/kategori" />'><span
                    class="fa fa-align-justify"></span> Daftar Kategori</a></li>
            <li id="sidebar-tambah-kategori"><a
                    href='<spring:url value="/administrator/kategori/tambah" />'><span
                    class="fa fa-plus-square-o"></span> Tambah Kategori</a></li>
         </ul>
      </li>
      <li id="sidebar-brand" class="xn-openable">
         <a href="#"><span class="fa fa-linux"></span> <span class="xn-text">Brands</span></a>
         <ul>
            <li id="sidebar-daftar-brand"><a
                    href='<spring:url value="/administrator/brand" />'><span
                    class="fa fa-align-justify"></span> Daftar Brands</a></li>
            <li id="sidebar-tambah-brand"><a
                    href='<spring:url value="/administrator/brand/tambah" />'><span
                    class="fa fa-plus-square-o"></span> Tambah Brands</a></li>
         </ul>
      </li>
      <li id="sidebar-member" class="xn-openable">
         <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Member</span></a>
         <ul>
            <li id="sidebar-daftar-member"><a
                    href='<spring:url value="/administrator/member" />'><span
                    class="fa fa-align-justify"></span> Daftar Member</a></li>
            <li id="sidebar-tambah-member"><a
                    href='<spring:url value="/administrator/member/tambah" />'><span
                    class="fa fa-plus-square-o"></span> Tambah Member</a></li>
         </ul>
      </li>
