   ...
   <div class="container">
      <div class="row">
         <div class="col-md-5">
            <h4>Tentang Kami</h4>
            <p>
               <a href='<spring:url value="/" />'>hardware.itsolution.com</a>, adalah Toko Online
               Terlengkap &amp;
            ...
            <p>
               ...
               hadir dengan beragam produk pilihan yang disertai promo istimewa &amp; menarik setiap
               hari.
            </p>
         </div> <!--/.col-md-5-->
...
<footer id="footer" class="midnight-blue">
   <div class="container">
      <div class="row">
         <div class="col-sm-6">
            &copy; 2015 <a target="_blank" href="http://shapebootstrap.net/">ShapeBootstrap</a>. All
            Rights Reserved.
         </div>
         <div class="col-sm-6">
            <div class="pull-right">
               <a id="gototop" class="gototop" href="#">Balik ke atas &nbsp;<span
